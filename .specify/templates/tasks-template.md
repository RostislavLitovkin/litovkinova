...
- [ ] T004 [P] Define automated quality gates (lint, format, tests) used by CI
...
- [ ] T011 [P] Identify reusable shared components/utilities and document reuse plan
- [ ] T012 [P] Define UX consistency checklist (states, copy, interaction patterns)
- [ ] T013 [P] Define responsive validation matrix for mobile and desktop breakpoints
...
- [ ] T023 [US1] Validate responsive behavior on mobile and desktop breakpoints
...
- [ ] T030 [US2] Validate UX consistency states for this story
- [ ] T031 [US2] Validate responsive behavior on mobile and desktop breakpoints
...
- [ ] T037 [US3] Validate UX consistency states for this story
- [ ] T038 [US3] Validate responsive behavior on mobile and desktop breakpoints
